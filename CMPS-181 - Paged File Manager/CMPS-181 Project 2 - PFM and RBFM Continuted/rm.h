...
private:
  ...
  void prepareIndexesRecordData(int32_t id, const string &tableName, const string &attr, void *data);
  ...
  RC insertIndex(int32_t id, const string &tableName, const string &attr);
  ...
  RC check_for_index(const string &tableName, vector<string> &attrs);
